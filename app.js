...
// ===== META LIVE PANEL =====
// META_LIVE_DATA v2 — ADO 按下單日精確拆分 (2026-04-22)
// 跨月場次按天數比例分配；DB1 GMV 為權威
var META_LIVE_DATA = {
  ...
  ado:    [109,434,172,207,196,436,612,903,641,763,788,834,736,512,423,149],
  aov:    [23048,4906,9696,9884,7328,4258,1876,1939,2785,2614,1989,2024,2036,3814,3268,20989],
  roas:   [0.97,1.1,2.2,3.33,3.3,2.7,3.2,2.2,1.6,0.5,0.7,1.7,0.3,2.5,2.9,2.8]
};
